...
mkdir /mnt/mfs/users/zoul15/var/www/TestApp -p
mkdir /mnt/mfs/users/zoul15/baseworkdir -p
mkdir /mnt/mfs/users/zoul15/errorfile -p
mkdir /mnt/mfs/users/zoul15/warningfile -p
